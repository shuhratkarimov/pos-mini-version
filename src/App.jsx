      ...
      <div className="min-h-screen bg-gray-100 p-4">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6 receipt">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold">SANTEXNIKA SAVDO</h1>
          ...
          <div className="border-t border-b border-gray-300 py-4 mb-4">
            {currentReceipt.items.map((item) => (
              <div key={item.id} className="flex justify-between items-center mb-2">
                ...
                <p className="font-bold">{item.total.toLocaleString()} so'm</p>
              </div>
            ))}
          </div>

          <div className="text-center mb-6">
            <p className="text-xl font-bold">JAMI: {currentReceipt.total.toLocaleString()} so'm</p>
          </div>
      ...
      <div className="container mx-auto p-4">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-center text-blue-600">SANTEXNIKA POS TIZIMI</h1>
            <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-xl font-bold mb-4">Mahsulotlar ({filteredProducts.length})</h2>
              ...
              <div className="space-y-3 max-h-64 overflow-y-auto mb-4">
                {cart.map((item) => (
                  <div key={item.id} className="border border-gray-200 rounded-lg p-3">
                    ...
                    <p className="font-bold text-blue-600">{item.total.toLocaleString()} so'm</p>
                  </div>
                ))}
              </div>
              ...
              {cart.length > 0 && (
                <>
                  <div className="border-t pt-4 mb-4">
                    <p className="text-xl font-bold text-center">JAMI: {totalAmount.toLocaleString()} so'm</p>
                  </div>
                  <button
